...
const Home = ({id}) => {
  return (
   ...
   <div className="hidden lg:block absolute right-20 top-42 border-cyan-700 lg:w-52 xl:w-80 border-2 lg:shadow-md xl:shadow-2xl rounded-lg overflow-hidden aspect-w-2 aspect-h-1 shadow-slate-50 border-r-8 border-b-8 z-0">
  <img
    src={pic}
    alt=""
